...
Interestlingly enough, the conditional probabilities of the NB model match the group means for the LDA and QDA models, a good sign for the upcoming predictions.
...
Give the three classifier models resulting near identicial group means and conditional probabilities, along with the near identical accuracy, the following area under the curve plots show results just short of 1.0.
